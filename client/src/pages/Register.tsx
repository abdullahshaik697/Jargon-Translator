...
const features = [
  { icon: '🏢', label: 'Corporate speak', desc: 'Office emails & memos decoded' },
  { icon: '💼', label: 'Job listings', desc: 'See what roles really demand' },
  { icon: '⚖️', label: 'Legal documents', desc: 'Contracts in plain English' },
  { icon: '👥', label: 'HR language', desc: 'Performance reviews unmasked' },
  { icon: '🚀', label: 'Startup / VC', desc: 'Pitch deck jargon exposed' },
];
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '8px' }}>
            <div style={{
              ...
              background: '#E8341A', borderRadius: '5px',
        ...
        {/* Feature list */}
        <div>
          <div style={{ width: '32px', height: '3px', background: '#E8341A', marginBottom: '24px' }} />
          <p style={{
            color: '#F7F4EF', fontSize: '15px',
            fontFamily: 'Georgia, serif', fontStyle: 'italic',
            marginBottom: '24px', lineHeight: 1.6,
          }}>
            5 modes. One mission.<br />
            <span style={{ color: '#E8341A' }}>The truth.</span>
          </p>
        ...
        <div style={{ width: '100%', maxWidth: '380px' }}>
          ...
          <div style={{ marginBottom: '28px' }}>
            ...
            <p style={{
              ...
              Already have one?{' '}
              <Link to="/login" style={{ color: '#E8341A', textDecoration: 'none', fontWeight: 500 }}>
                Sign in
              </Link>
            </p>
          </div>
          ...
          <button
            ...
            style={{
              ...
              color: '#333', cursor: 'pointer', marginBottom: '20px',
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
              ...
              <div style={{ position: 'relative' }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    cursor: 'pointer', color: '#bbb', fontSize: '13px', padding: 0,
                  }}
            ...
            <div>
              ...
              <input
                ...
                style={{
                  width: '100%', padding: '10px 14px',
                  border: `1.5px solid ${passwordsMatch ? '#10B981' : passwordsMismatch ? '#E8341A' : '#E0DCD4'}`,
                ...
                onFocus={e => {
                  if (!form.confirmPassword) e.target.style.borderColor = '#0F0F0F';
                }}
                onBlur={e => {
                  if (!form.confirmPassword) e.target.style.borderColor = '#E0DCD4';
                }}
              />
              {form.confirmPassword && (
                <p style={{
                  fontSize: '11px', margin: '4px 0 0',
                  color: passwordsMatch ? '#10B981' : '#E8341A',
                  fontFamily: 'Roboto, sans-serif',
                }}>
